...
const commercialPlayer = await readFile(new URL("../nbx/nexbanner-player-20260726-1.js", import.meta.url), "utf8");
...
test("commercial loader uses the immutable commercial player asset", () => {
  assert.match(commercialLoader, /nexbanner-player-20260726-1\.js/);
...
test("deployment player is minified and exposes the commercial test hooks", () => {
  ...
  assert.match(commercialPlayer, /contentWindow\.document\.write/);

...
const commercialPlayer = await readFile(new URL("../nbx/nexbanner-player-20260725-3.js", import.meta.url), "utf8");
...
test("commercial loader uses the immutable commercial player asset", () => {
  assert.match(commercialLoader, /nexbanner-player-20260725-3\.js/);
